      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#addExaminations">Add Exams</button>
            </li>
          ...
          <div class="tab-content pt-2">
            <div class="tab-pane fade show active profile-overview" id="addExaminations">
            <br><br>
            <div class="table">
            <h3>JOB LISTS</h3>
            <table class="table table-sm table-hover" id="example" style="font-family: 'Jamesphilip Bold', sans-serif !important; text-align: center;">
                <thead>
                  <tr>
                    <th>Job ID</th>
                    <th>Job Code</th>
                ...
                <tbody>
                  ...
                  $query = "SELECT *, DATE_FORMAT(date_posted, '%M %d, %Y')as formatted_date 
                  FROM hr_job_list ";
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-sm addExamBtn" style="background: #57d8cd; color: #fff;">Add Exam</button>
                        </td>
             ...
             <div class="table">
              <h3>ADDED EXAMINATIONS</h3>
               <!-- Table for Questions -->
               <table class="table table-sm table-hover" id="example01" style="font-family: 'Jamesphilip Bold', sans-serif !important; text-align: center;">
                <thead>
                  <tr>
                    <th>Exam ID</th>
                    <th>Job Code</th>
                ...
                <tbody>
                  ...
                  $query = "SELECT job.*, exam.* 
                  FROM hr_job_list job, hr1_exam exam 
                  WHERE job.id = exam.job_list_id";
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $row['num_items']; ?> items</td>
                        <?php
                        if ($row['exam_status'] === "Pending") { ?>
                          <td><span class="badge bg-warning" style="color: black;">Pending</span></td>
                          <td><button class="btn btn-sm addQuestionBtn" style="background: #57d8cd; color: #fff;">Add Questions</button></td>
                ...
                <div class="modal fade" id="addExamBtn" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content" style="font-family: 'Jamesphilip Bold', sans-serif; background: #fff;">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="submit" name="add_exam" class="btn" style="background: #57d8cd; color: #fff;">Add Exam</button>
                      </div>
                      </form>
                    <?php } ?>
                    </div>
                ...
                <div class="modal fade" id="updateExamBtn" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content" style="background: #fff; font-family: 'Jamesphilip Bold', sans-serif">
                      <div class="modal-header">
                ...
                <div class="modal fade" id="addQuestionBtn" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content" style="background: #fff; font-family: 'Jamesphilip Bold', sans-serif;">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" name="add_questions" class="btn" style="background: #57d8cd; color: #fff;">Add Questions</button>
                      </div>
                      </form>
                    <?php } ?>
                    </div>
