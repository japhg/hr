				...
				<div class="container">
					<div class="row justify-content-center">
						...
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							...
							<h2 class="text-center " style="color: #6559ca; font-family: 'Roboto', sans-serif; font-weight: 800;">FORGOT PASSWORD</h2>
                                        
								<br><br>
								<p style="font-family: 'Roboto', sans-serif; text-align: center;">Enter your email address</p>
						...
						<div class="row justify-content-center">
							...
							<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
								...
								<h2 class="text-center " style="color: #6559ca; font-family: 'Roboto', sans-serif; font-weight: 800;">FORGOT PASSWORD</h2>
									...
									<br><br>
									<h5 style="font-family: 'Roboto', sans-serif; text-align: center;">Enter the code sent to your Email</h5>
