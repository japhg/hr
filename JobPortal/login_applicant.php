...
<head>
    ...
    <link rel="stylesheet" href="css/style/login_applicant.css">
              ...
              <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="card mb-3" style="border: none;">
                  ...
                  <div class="card-body" id="card-body" style="background: #2d2d52; color: white;">
                    <div class="pt-4 pb-2">
                      <h2 class="card-title text-center " style="color: #FFF; font-family: 'Inter', sans-serif; font-weight: 800;">LOGIN TO YOUR ACCOUNT</h2>
                      <br>
                    </div>
                    ...
                    <div class="form-floating">
                      ...
                      <br><br>
                      <div class="col-12">
                        <a href="index.php" style="color: #fff; ">Cancel Login</a>
                      </div>
                    </form>
                  </div>
                </div>
